...
function encryptPhoto() {
    ...
    document.getElementById('valueEncryptionLength').innerHTML = "" + encrypted.length;
}
...
//3
var firebaseConfig = {
    apiKey: "AIzaSyBpXyz5gUGgrR6Biq6p-kvsRY5GVTIYqXI",
    authDomain: "szyfrowanie1-ce6e4.firebaseapp.com",
    databaseURL: "https://szyfrowanie1-ce6e4.firebaseio.com",
    projectId: "szyfrowanie1-ce6e4",
    storageBucket: "szyfrowanie1-ce6e4.appspot.com",
    messagingSenderId: "710886564169",
    appId: "1:710886564169:web:c8095d076f93c410657a98"
};
...
function sendData() {
    ...
    var encryptedDataBase = CryptoJS.TripleDES.encrypt(contentValue, passwordValue);
...
function getData() {
    firebase.database().ref('/').once('value', function (snapshot)
    {
        snapshot.forEach(function (childSnapshot) {
           ...
           var valueDecryptedToPrint = CryptoJS.TripleDES.decrypt(stringEncryptedValue, passwordValue);
           document.getElementById('getDataBaseDecrypted').innerHTML = valueDecryptedToPrint.toString(
               CryptoJS.enc.Utf8
           );
        })
    })
